...
plt.axvline(x=alpha_ótimo, color='purple',
            label=f'alpha: {alpha_ótimo:0.5f}')
plt.legend()


# In[ ]: Reestimação do modelo binomial negativo com o parâmetro 'alpha_ótimo'
...
# In[38]: Estimação do 'modelo_poisson2'
...
# In[ ]: Estimação do 'modelo_bneg2' com o parâmetro 'alpha_ótimo'
...
# In[46]: Plotagem das funções estabelecidas
